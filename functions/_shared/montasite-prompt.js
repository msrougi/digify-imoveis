...
Criar uma única matéria original com no mínimo 1.000 e no máximo 3.000 palavras, ligada ao empreendimento e sem canibalizar posts existentes. Trabalhar a intenção de busca com profundidade, subtítulos úteis, leitura natural e fatos confirmados. Usar como imagem de destaque uma imagem real do PDF do empreendimento, com alt text descritivo, Open Graph, Twitter Card e propriedade image no JSON-LD; a matéria não pode ser publicada sem essa imagem. Inserir um link interno natural para https://imoveis.digify.live/${clean(payload?.slug, "projeto")}/, adicionar ao blog, sitemap e RSS. Validar automaticamente a contagem de palavras e a presença da imagem antes de agendar e novamente antes de publicar. Publicar somente no horário agendado. Só depois de confirmar resposta pública da URL, enviar e-mail para marcelo@digify.live.
